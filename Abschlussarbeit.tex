...
\begin{document}
	...
	\begin{acronym}
		...
		\acro{16Int}{16 bit sigend integer} \acro{CLI}{Commend Line Interface} \acro{CT}{Computertomografie}
		\acro{GB}{Gigabyte } \acro{GUI}{Grafical User Interface} \acro{Html}{Hypertext Markup Language}
		...
		\acro{MVC}{Model View Controller} \acro{PyPi}{Python-Paket-Index} \acro{SEM}{Slicer Extension Module}
		\acro{THA}{Technische Hochschule Augsburg} \acro{UI}{User Interface} \acro{UML}{Unified Modeling Language}
		\acro{UX}{User Experience} \acro{VTK}{Visualization Toolkit} \acro{XML}{Extensible Markup Language}
