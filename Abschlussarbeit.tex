...
\begin{document}
	...
	\begin{abstract}
		\section*{Kurzfassung}
		3D Slicer ist eines größten Open Source Projekt mit einer der stärksten Gemeinschaften.
		Es hat sich über die Jahre hinweg in den unterschiedlichsten Kliniken
		etablierte. So kommte es, dass auch die Klinik für Zahnerhaltung und
		Parodontologie in München diese Plattform bereits in ihren Forschungsaltag
		integriert haben. Ziel dieser vorliegenden Arbeit war die Erstellung eines Moduls
		für die Software 3D Slicer um so die Ärzte in der Zahnklinik zu unterstüzten.
		Dabei sollte ein bereits prototypisch bestehender Algorihmus überarbeitet
		...
		Klicks über eine UI zu starten. Neben dem Mehrwert, den die Awendung für die
		praktizierenden Ärzte liefert, konnten auch viele Erfahrunge mit der Slicer
		Entwicklung gemacht werden, sodass am Ende ein guter Überblick über die wichtigsten
		Punkte in der Entwicklung besteht.
	\end{abstract}
