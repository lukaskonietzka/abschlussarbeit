...
\begin{document}
	...
	\begin{acronym}
		...
		\acro{ISQ}{Industrial Scan Quality} \acro{16Int}{16 bit sigend integer} \acro{8UInt}{8 unsigend integer}
		...
		\acro{THA}{Technische Hochschule Augsburg} \acro{GB}{Gigabyte } \acro{PyPi}{Python-Pakte-Index}
