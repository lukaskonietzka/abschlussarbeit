...
\begin{document}
	...
	\begin{acronym}
		[SQL] \acro{UI}{User Interface} \acro{CT}{Computertomografie} \acro{MVC}{Model View Controller}
		\acro{MRML}{Medical Reality Modeling Language} \acro{SEM}{Slicer Extension Module}
		\acro{XML}{Extensible Markup Language} \acro{3D}{dreidimensonale} \acro{UX}{User Experience}
	\end{acronym}
