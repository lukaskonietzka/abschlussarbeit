...
Betrachtet man konkrete dei Testmethode \texttt{testIsSmoothed()} genauer, so
...
ca. 500 \ac{MB} eine ausgeprägte Größe haben, wurden diese vorerst in einem separaten
