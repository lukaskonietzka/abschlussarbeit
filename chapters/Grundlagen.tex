...
\subsection{Extention Manager und Plugin Infrastruktur}
...
\begin{minipage}{0.60\textwidth}
	...
	\label{fig:3d_slicer_extetion_index}
\end{minipage}

Slicer realisiert dies, indem die Plattform über ein zusätzliches Reporsitory
verfühgt, dass sich \href{https://github.com/Slicer/ExtensionsIndex?tab=readme-ov-file}{\textit{ExtentionIndex}}
...
\href{https://github.com/Slicer/ExtensionsIndex?tab=readme-ov-file}{\textit{ExtentionIndex}}
...
erstellt build-Datei installiert werden kann. Abbildung \ref{fig:3d_slicer_extetion_index}
...
Probe zugreifen. So kann diese Information über eine Verkettung der Typen erfolgen
