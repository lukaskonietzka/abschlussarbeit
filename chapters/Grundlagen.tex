...
Anordnung der Bilder, es genügt das Bildhistogramm. Im ersten Schritt unterteilt
Renyi die Grauwerte der Voxel wieder in unterschiedliche Klasse. Dabei wird
zunächst ein Schwellwert gebildet, der noch nicht optinal ist. Anschließend soll
die Entropie der einzelnen Klassen bestimmt werden. Die Gleichung ... soll dies verdeutlichen.

Eine Entropie ist ein Konzept, das Unordnung, Unsicherheit oder Informationsgehalt
beschreibt.
