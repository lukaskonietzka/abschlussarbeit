...
der entsprechenden Logik gedrückt wird, wird die Methode \texttt{execute()} ausgeführt
...
Evaluation der Ergebnisse begonnen werden. Ein wichtiger Teil sind die Testergebnisse
...
sich mit der Testauswertung der verschiedenen Testfälle. Begonnen wird mit einer
...
geprägt, wie lange ein einzelnes Bild benötigt. Ist die Zeit eines einzelnen
Bildes bekannt, so lässt sich gut prognostizieren, wie lange eine Verarbeitung
von $n$ vielen Bildern dauert. Wie bereits angedeutet, hängt die Zeit eines
einzelnen Bilds von vielen Faktoren ab. In diesem Fall würde die Bearbeitung von
