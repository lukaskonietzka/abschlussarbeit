    ...
    peg$SyntaxError.prototype.format = function(sources) {
      ...
      if (this.location) {
        ...
        if (src) {
          ...
          var line5 = src[s2.line - 1];
          var last = s2.line === e.line ? e.column : line5.length + 1;
...
var systeme_environment_default = (
  ...
  function() {
    ...
    function peg$parse(input, options) {
      ...
      var peg$f5 = function(line5, sep, comment2) {
        return { ...line5, sep: [].concat(sep), trailingComment: comment2 };
      };
      var peg$f6 = function(line5, comment2) {
        return { ...line5, trailingComment: comment2 };
      };
...
// ../unified-latex-ctan/package/tikz/libs/tikz-command-argument-parser.ts
var OPTIONAL_ARGUMENT_ARG_SPEC = parse("o")[0];

// ../unified-latex-ctan/package/tikz/libs/parser.ts
...
// ../unified-latex-util-pgfkeys/dist/index.js
...
// ../unified-latex-util-align/dist/index.js
...
function printLatexAst(path2, options, print) {
  ...
  switch (node.type) {
    ...
    case "comment":
      return printComment(path2, print, options);
    case "environment":
    case "mathenv":
    ...
    case "verbatim":
      return printVerbatimEnvironment(path2, print, options);
    case "whitespace":
      return line2;
    default:
...
var OPTIONAL_ARGUMENT_ARG_SPEC2 = parse("o")[0];
function blankArg() {
  return arg([], { openMark: "", closeMark: "" });
}
var tikzCommandArgumentParser2 = (nodes, startPos) => {
  ...
  } = gobbleSingleArgument(nodes, OPTIONAL_ARGUMENT_ARG_SPEC2, pos);
  nodesRemoved += optionalArgumentNodesRemoved;
...
var macros12 = {
  ...
  tikz: {
    signature: "o o m",
    argumentParser: tikzCommandArgumentParser2,
...
// ../unified-latex-util-parse/dist/index.js
